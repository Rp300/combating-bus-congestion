...
|Courses Data|<ul> <li>**Enrollment**: Number of students in all classes coded by class CRNs.</li> <li>**Schedule**: The meeting time and location for all classes coded by class CRNs are available at https://courses.illinois.edu/schedule/DEFAULT/DEFAULT. You may need a script to pull all the data down. This documenation may help https://courses.illinois.edu/cisdocs/</li> </ul>|
